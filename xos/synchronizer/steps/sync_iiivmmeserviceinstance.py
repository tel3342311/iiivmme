...
class SyncIIIVMMEServiceInstance(SyncInstanceUsingAnsible):
    observes = IIIVMMEServiceInstance
    template_name = "iiivmmeserviceinstance_playbook.yaml"
    service_key_name = "/opt/xos/configurations/mcord/mcord_private_key"

    def __init__(self, *args, **kwargs):
        super(SyncIIIVMMEServiceInstance, self).__init__(*args, **kwargs)

    def get_service(self, o):
        if not o.owner:
            return None

        service = IIIVMMEService.objects.filter(id=o.owner.id)
